...
VPINBALL_VERSION = 545c347d5562516fe4eb6ed9baf6a93c73f6726a
...
define VPINBALL_CMAKE_HACKS
    ...
    $(SED) 's:$${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/atl/include:$(STAGING_DIR)/usr/include/libwinevbs/atl\n   $${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/atl/include:g' $(@D)/CMakeLists.txt
    $(SED) 's:$${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/atlmfc/include:$(STAGING_DIR)/usr/include/libwinevbs/atlmfc\n   $${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/atlmfc/include:g' $(@D)/CMakeLists.txt
    $(SED) 's:$${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/wine/include:$(STAGING_DIR)/usr/include/libwinevbs/wine\n   $${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/wine/include:g' $(@D)/CMakeLists.txt
    ...
    for f in $(@D)/make/CMakeLists_plugin_*.txt; do \
        ...
        $(SED) 's:$${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/atl/include:$(STAGING_DIR)/usr/include/libwinevbs/atl\n      $${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/atl/include:g' $$f; \
        $(SED) 's:$${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/atlmfc/include:$(STAGING_DIR)/usr/include/libwinevbs/atlmfc\n      $${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/atlmfc/include:g' $$f; \
        $(SED) 's:$${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/wine/include:$(STAGING_DIR)/usr/include/libwinevbs/wine\n      $${CMAKE_SOURCE_DIR}/third-party/include/libwinevbs/wine/include:g' $$f; \
