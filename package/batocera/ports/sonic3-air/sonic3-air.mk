...
define SONIC3_AIR_DISABLE_ENFORCED_DEBUG_MODE
	$(SED) 's/"EnforceDebugMode": "1"/"EnforceDebugMode": "0"/' \
		$(@D)/Oxygen/sonic3air/config.json
endef
SONIC3_AIR_POST_PATCH_HOOKS += SONIC3_AIR_DISABLE_ENFORCED_DEBUG_MODE
