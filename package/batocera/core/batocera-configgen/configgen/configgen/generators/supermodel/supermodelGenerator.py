...
def configPadsIni(system: Emulator, rom: Path, guns: Guns) -> None:
    ...
    if m3_outputs == "net":
        ...
        targetConfig.set("Global", "OutputsTCPPort", system.config.get("m3_outputs_tcp", "0"))
        targetConfig.set("Global", "OutputsUDPBroadcastPort", system.config.get("m3_outputs_udp", "0"))
    else:
