...
class CannonballGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        ET.SubElement(video, "vsync").text = system.config.get("vsync", "1")
        ...
        ET.SubElement(sound, "fix_samples").text = "0"
        ...
        ET.SubElement(controls, "gear").text = system.config.get("gear_mode", "3")
